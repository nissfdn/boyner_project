                ...
                <div class="cart-merchant-items_cartMerchantItemsItem__E9sX_">
                    ...
                    <div class="cart-cargo-info_cartCargoInfo__Nzj3k">
                        <p class="b-typography b-typography--p14 cart-cargo-info_cartCargoInfoMerchantName__BnnBZ" style="color: var(--semantic-foreground-secondary);">
                            Satıcı: <a href="/BOYNER-m-1" style="text-decoration: underline;">BOYNER</a>
                        </p>
                    ...
                    <div class="cart-merchant-items_cartMerchantItemsItemCard__MYN2x">
                        <div class="cart-product-desktop_cartProduct__q59ul">
                            ...
                            <div class="product-image_productImage__k6kQq cart-product-desktop_cartProductImage__iaTzI">
                                <a class="product-image_productImageWrapper__Whoo_" href="/discovery-expedition-ekru-erkek-cocuk-baskili-sweatshirt-d5wb-swt3042-p-15625115" style="text-decoration: none;">
                                ...
                                <div class="product-image_productImageBottom__f22Y8"></div>
                            </div>
                            ...
                            <div class="cart-product-desktop_cartProductDetail__OpOLd">
                                <div class="cart-product-desktop_cartProductDetailBox__qClDi cart-product-desktop_cartProductDetailItem__LnYFZ">
                                    ...
                                    <p class="b-typography b-typography--p12 product-cargo_productCargo__fqPnu cart-product-desktop_cartProductDetailBoxItem__PFBxR">
                                        ...
                                        <span>Tahmini 25 Aralık Perşembe Kargoda</span>
                                    </p>
    
                                    <div class="product-campaign_productCampaign__KeQIP cart-product-desktop_cartProductDetailBoxItem__PFBxR cart-product-desktop_cartProductDetailBoxItemCampaign__Cqt4w">
                                        <i class="b-icon b-icon--hangtag-medium" style="font-size: 14px;"></i>
                                        <h6 class="b-typography b-typography--h7 product-campaign_productCampaignLabel__VeQ5v b-typography--ellipsis" style="-webkit-line-clamp: 1;">Akşam Kampanyası-Sepette %15 İndirim</h6>
                                        <h6 class="b-typography b-typography--h7 product-campaign_productCampaignButton__h7Sln">
                                            Uygulandı&nbsp;<i class="b-icon b-icon--checkmark-medium product-campaign_productCampaignButtonIcon__IrCUy" style="font-size: 12px;"></i>
                                        </h6>
                                    </div>
    
                                   
    
                                    <div class="product-statistics_productStatistics__cMEvV cart-product-desktop_cartProductDetailBoxItem__PFBxR">
                                        <div class="product-statistics_productStatisticsWrapper__EDm_w">
                                            <i class="b-icon b-icon--fire-bold-1" style="color: var(--semantic-accent-primary); font-size: 16px;"></i>
                                            <p class="b-typography b-typography--p12 product-statistics_productStatisticsWrapperText__VdDOf">
                                                <strong>6</strong> kişinin sepetinde
                                            </p>
                                        </div>
                                    </div>
    
                                    <div class="cart-product-desktop_cartProductDetailBoxItem__PFBxR cart-product-desktop_cartProductDetailBoxItemGiftPackage__T_Baf">
                                        <label class="b-typography b-typography--p12 b-checkbox b-checkbox--large b-checkbox--align-center b-checkbox--filled" for=":r0:">
                                            <input type="checkbox" class="b-checkbox__input" id=":r0:" aria-invalid="false" aria-disabled="false" role="checkbox" aria-checked="false">
                                            <div class="b-checkbox__box" aria-hidden="true">
                                                <i class="b-icon b-icon--checkmark-medium b-checkbox__box__icon"></i>
                                            </div>
                                            <div class="b-checkbox__label">Hediye Paketi İstiyorum</div>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="product-counter_productCounterWrapper__mHw67">
                                  ...
                                  <div class="product-counter_productCounter__1M5DI">
                                        <button class="b-button b-button--base b-button--medium b-button--text-style-heading product-counter_productCounterButton__eJIBf" type="button" aria-disabled="false" aria-busy="false">
                                            <i class="b-icon b-icon--minus-medium b-button__icon" style="font-size: 16px;"></i>
                                        </button>
                                        <input type="number" class="product-counter_productCounterInput__s8rq2" value=1 >
                                        <button class="b-button b-button--base b-button--medium b-button--text-style-heading product-counter_productCounterButton__eJIBf" type="button" aria-disabled="false" aria-busy="false">
                                            <i class="b-icon b-icon--plus-bold b-button__icon" style="font-size: 16px;"></i>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="favorite_favorite__eM4RC">
                                    <button class="b-button b-button--base b-button--medium b-button--text-style-heading favorite_favoriteButton__7JTcw" type="button" aria-disabled="false" aria-busy="false" style="width: 24px; height: 24px;">
                                        <i class="b-icon b-icon--heart-medium favorite_favoriteButtonIcon__nri1a" style="font-size: 24px;"></i>
                                        <i class="b-icon b-icon--heart-full favorite_favoriteButtonIcon__nri1a favorite_favoriteButtonHoverIcon__0wg0u" style="font-size: 24px;"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
        ...
        <div class="b-grid b-grid--col b-grid--col-4 b-grid--col-lg-4 b-grid--col-xl-3 b-grid--col-lg-0-offset">
            <div class="cart-order-summary_cartOrderSummary__DM8q3">
                ...
                <button class="b-button b-button--primary b-button--large b-button--fluid b-button--icon-position-right b-button--text-style-heading" type="button" aria-disabled="false" aria-busy="false" aria-label="SEPETİ ONAYLA">
                    <span class="b-typography b-typography--h5 b-typography--ellipsis" style="-webkit-line-clamp: 1;">SEPETİ ONAYLA</span>
